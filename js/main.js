...
const translations = {
  ...
  'article.en-placeholder': { ko: '', en: 'English translation coming soon.' },
};
...
(function() {
  ...
  function applyLang(lang) {
    ...
    if (articleBody) {
      let placeholder = articleBody.querySelector('.en-placeholder');
      if (lang === 'en') {
        articleBody.style.opacity = '0.5';
        if (!placeholder) {
          placeholder = document.createElement('div');
          placeholder.className = 'en-placeholder';
          placeholder.style.cssText = 'text-align:center; padding:32px; font-size:12px; color:#aaa; letter-spacing:0.1em; text-transform:uppercase;';
          placeholder.textContent = 'English translation coming soon.';
          articleBody.insertBefore(placeholder, articleBody.firstChild);
        }
      } else {
